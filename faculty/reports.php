...
render_dashboard_layout('Faculty Reports', 'teacher', 'reports', 'faculty/reports.css', 'faculty/reports.js', function () use ($teacher, $summary, $attendanceHistory, $markUploads, $assignmentRows): void {
    ?>
    ...
    <section class="grid-2">
        <article class="data-card">
            ...
            <?php if ($attendanceHistory): ?>
                <div class="table-wrap"><table><thead><tr><th>Date</th><th>Present</th><th>Absent</th><th>Total</th></tr></thead><tbody><?php foreach ($attendanceHistory as $row): ?><tr><td><?= e($row['attendance_date']) ?></td><td><?= e((string) $row['present_count']) ?></td><td><?= e((string) $row['absent_count']) ?></td><td><?= e((string) $row['total_count']) ?></td></tr><?php endforeach; ?></tbody></table></div>
            <?php else: ?>
        ...
        <article class="data-card">
            ...
            <?php if ($markUploads): ?>
                <div class="table-wrap"><table><thead><tr><th>Subject</th><th>Exam</th><th>Max Marks</th><th>Uploaded</th></tr></thead><tbody><?php foreach ($markUploads as $row): ?><tr><td><?= e($row['subject_name']) ?></td><td><?= e($row['exam_type']) ?></td><td><?= e((string) $row['max_marks']) ?></td><td><?= e((string) $row['uploaded_at']) ?></td></tr><?php endforeach; ?></tbody></table></div>
            <?php else: ?>
    ...
    <article class="data-card">
        ...
        <?php if ($assignmentRows): ?>
            <div class="table-wrap"><table><thead><tr><th>Subject</th><th>Assignment</th><th>Submitted</th><th>Tracked</th></tr></thead><tbody><?php foreach ($assignmentRows as $row): ?><tr><td><?= e($row['subject_name']) ?></td><td><?= e($row['assignment_label']) ?></td><td><?= e((string) $row['submitted_count']) ?></td><td><?= e((string) $row['tracked_count']) ?></td></tr><?php endforeach; ?></tbody></table></div>
        <?php else: ?>
