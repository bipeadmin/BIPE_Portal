...
$targetOptions = support_feedback_target_options('student', (int) $student['id']);
$targetRoleLabels = [
    'admin' => 'Admin',
    'student' => 'Student',
    'teacher' => 'Faculty',
...
if (is_post()) {
    try {
        ...
        audit_log('student', (string) $student['enrollment_no'], 'FEEDBACK_SUBMITTED', ucfirst((string) $request['category']) . ' #' . (int) $request['id'] . ' submitted');
    ...
    redirect_to('student/feedback.php');
}

$unseenResponses = support_request_unseen_response_rows('student', (int) $student['id']);
...
if ($unseenResponses) {
    mark_support_request_responses_seen('student', (int) $student['id']);
}

$historyRows = support_request_sender_rows('student', (int) $student['id']);

render_dashboard_layout('Feedback & Query', 'student', 'feedback', 'student/feedback.css', 'student/feedback.js', function () use ($targetOptions, $historyRows, $availableTargetRoles): void {
    ?>
                ...
                <div class="feedback-recipient-panel" data-feedback-picker>
                    <div class="form-grid two">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-hint" data-feedback-hint>Select a recipient category to load matching users.</p>
                        </div>
                    </div>
                </div>
